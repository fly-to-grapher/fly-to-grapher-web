    ...
    <nav  className="container-fluid bg-black px-5 ">
      <div className="navbar navbar-expand-lg navbar-dark d-flex justify-content-between">
        <Link to="/">
          {nav ?
            <img src="./assert/flytog.png" className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes"
              width="155px" height="150px" loading="lazy" />
            :
        ...
        <div className="d-flex justify-content-center">
          <div className="nav-item dropdown d-flex justify-content-center align-items-center me-4" style={{ color: "white" }}>
            ...
            <ul className="dropdown-menu " style={{}} aria-labelledby="navbarDropdown">

              <li> <Link to="/account" className="dropdown-item" style={{ color: "black" }} >Your profile</Link></li>
